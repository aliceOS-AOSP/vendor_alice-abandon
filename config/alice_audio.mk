...
ALARM_PATH := vendor/alice/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/alice/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/alice/prebuilt/common/media/audio/ringtones
